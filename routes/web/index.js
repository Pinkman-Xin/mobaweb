module.exports = app => {
    ...
    router.get('/news/init', async (req, res) => {
        ...
        router.get('/videos/list',async(req,res)=>{
            const data = await Ad.find().limit(10).lean()
            res.send(data)
        })
    //获取新闻接口
